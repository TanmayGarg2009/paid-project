...
export const DEFAULT_REVIEWS = [
  {
    ...
    comment: 'NorthStack Digitals delivered our custom reporting portal 2 days ahead of the target delivery date. The code was exceptionally clean, TypeScript types were rigorous, and the 50/50 payment model gave us complete confidence.',
    isPublished: true,
    isFeatured: true,
  ...
  },
  {
    ...
    comment: 'The custom Paper plugin and Fabric mod developed by NorthStack outperformed everything else we tested. Async chunk handling was flawless.',
    isPublished: true,
    isFeatured: true,
