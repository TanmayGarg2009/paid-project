...
async function main() {
  ...
  const portfolioData = [
    ...
    },
    {
      ...
      clientName: 'Vortex Network (play.vortextiers.buzz)',
      ...
      contentMdx: 'Custom branded web store built with Oxanium and JetBrains typography, Tebex/Razorpay checkout integration, one-click server IP copy (play.vortextiers.buzz), and real-time server status ping.',
      coverImage: 'https://images.unsplash.com/photo-1511512578047-dfb367046420?q=80&w=1200&auto=format&fit=crop',
      galleryImages: [],
      liveUrl: 'https://store.vortextiers.buzz/',
  ...
  console.log('✅ Created 10 Verified Portfolio Showcases');
